-- =====================================================
-- SUPABASE PAYROLL CALCULATOR SETUP - FIXED VERSION
...
-- =====================================================
-- 6.2 LOGIN ACTIVITY POLICIES
-- =====================================================

DROP POLICY IF EXISTS "login_activity_select_policy" ON login_activity;
DROP POLICY IF EXISTS "login_activity_insert_policy" ON login_activity;
...
-- =====================================================
-- 6.4 PAY COMPONENTS POLICIES
-- =====================================================

DROP POLICY IF EXISTS "pay_components_select_policy" ON pay_components;
DROP POLICY IF EXISTS "pay_components_insert_policy" ON pay_components;
DROP POLICY IF EXISTS "pay_components_update_policy" ON pay_components;
DROP POLICY IF EXISTS "pay_components_delete_policy" ON pay_components;

-- All authenticated users can read active pay components
...
-- =====================================================
-- 6.5 PAYROLL RUNS POLICIES
-- =====================================================

DROP POLICY IF EXISTS "payroll_runs_select_policy" ON payroll_runs;
DROP POLICY IF EXISTS "payroll_runs_insert_policy" ON payroll_runs;
DROP POLICY IF EXISTS "payroll_runs_update_policy" ON payroll_runs;
DROP POLICY IF EXISTS "payroll_runs_delete_policy" ON payroll_runs;
...
-- =====================================================
-- 6.6 PAYROLL LINES POLICIES
-- =====================================================

DROP POLICY IF EXISTS "payroll_lines_select_policy" ON payroll_lines;
DROP POLICY IF EXISTS "payroll_lines_insert_policy" ON payroll_lines;
DROP POLICY IF EXISTS "payroll_lines_update_policy" ON payroll_lines;
DROP POLICY IF EXISTS "payroll_lines_delete_policy" ON payroll_lines;
...
-- =====================================================
-- 6.7 PAYROLL LINE COMPONENTS POLICIES
-- =====================================================

DROP POLICY IF EXISTS "payroll_line_components_select_policy" ON payroll_line_components;
DROP POLICY IF EXISTS "payroll_line_components_insert_policy" ON payroll_line_components;
DROP POLICY IF EXISTS "payroll_line_components_update_policy" ON payroll_line_components;
DROP POLICY IF EXISTS "payroll_line_components_delete_policy" ON payroll_line_components;
...
-- =====================================================
-- 6.8 EMPLOYEE COMPONENT SELECTIONS POLICIES
-- =====================================================

DROP POLICY IF EXISTS "employee_selections_select_policy" ON employee_component_selections;
DROP POLICY IF EXISTS "employee_selections_insert_policy" ON employee_component_selections;
DROP POLICY IF EXISTS "employee_selections_update_policy" ON employee_component_selections;
DROP POLICY IF EXISTS "employee_selections_delete_policy" ON employee_component_selections;
...
DO $$
BEGIN
    RAISE NOTICE '=== SUPABASE PAYROLL CALCULATOR SETUP COMPLETED ===';
    RAISE NOTICE 'Tables created: 8 core tables';
    RAISE NOTICE 'Indexes created: 20+ performance indexes';
    RAISE NOTICE 'RLS policies applied: 30+ security policies';
    RAISE NOTICE 'Views created: 2 reporting views';
    RAISE NOTICE 'Functions created: 3 utility functions';
    RAISE NOTICE 'Sample data: 12 pay components added';
    RAISE NOTICE 'Default admin user: admin@coaltools.com';
    RAISE NOTICE '================================================';
