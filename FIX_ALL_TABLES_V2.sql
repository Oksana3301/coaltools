-- ===================================================
-- COMPREHENSIVE FIX FOR ALL COALTOOLS TABLES - V2
-- Fixed column name casing issues
-- ===================================================
...
-- Note: Foreign keys akan kita tambahkan nanti setelah semua table ada
...
-- ===================================================
-- 8. ADD FOREIGN KEYS (if tables already have data, skip this)
-- ===================================================
DO $$
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE conname = 'payroll_lines_payrollRunId_fkey'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'payroll_lines_employeeId_fkey'
    ) THEN
        ALTER TABLE payroll_lines 
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'payroll_line_components_payrollLineId_fkey'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'payroll_line_components_componentId_fkey'
    ) THEN
        ALTER TABLE payroll_line_components 
...
UNION ALL
SELECT 'payroll_line_components', COUNT(*) FROM payroll_line_components
UNION ALL
