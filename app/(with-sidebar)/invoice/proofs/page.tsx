...
export default function InvoiceProofsPage() {
  ...
  useEffect(() => {
    ...
    const storedProofs = localStorage.getItem('invoiceTransferProofs')
    const storedHeader = localStorage.getItem('invoiceHeaderImage')
  ...
  const generateProofsPDF = () => {
    const htmlContent = `
      ...
      <html>
      <head>
        <title>Bukti Transfer Invoice</title>
        <style>
          @page {
            size: A4 portrait;
    ...
    if (printWindow) {
      ...
      printWindow.document.title = 'Bukti Transfer Invoice'
      printWindow.focus()
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Dokumen bukti transfer dan nota invoice</p>
            </div>
        ...
        {headerImage && (
          <Card className="mb-8">
            <CardHeader>
              <CardTitle>Header Invoice</CardTitle>
            </CardHeader>
            <CardContent>
